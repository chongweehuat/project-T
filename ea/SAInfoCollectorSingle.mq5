...
// Input Parameters
input string EA_Version   = "1.31 MT5"; // EA Version
...
string BuildAllTradesPayload()
{
    ...
    for (int i = 0; i < totalTrades; i++)
    {
        if (m_position.SelectByIndex(i))
        {
            ...
            tradeData += "current_price=" + DoubleToString(m_position.PriceCurrent(), 5) + "|";
...
string BuildAccountInfo()
{
    ...
    payload += "open_count=" + IntegerToString(total_open_count) + "&";
    payload += "total_volume=" + DoubleToString(total_volume, 2) + "&";
